    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('OWNER', 'Ordinationsinhaber/in'), ('EMPLOYEE', 'Mitarbeiter/in')], max_length=10)),
                ('hourly_rate', models.DecimalField(decimal_places=2, max_digits=6, validators=[django.core.validators.MinValueValidator(Decimal('0.01'))], verbose_name='Stundenlohn')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_time', models.TimeField(verbose_name='Beginn')),
                ('end_time', models.TimeField(verbose_name='Ende')),
                ('break_duration', models.DurationField(default='0:30:00', verbose_name='Pausendauer')),
                ('shift_type', models.CharField(choices=[('MORNING', 'Vormittag'), ('AFTERNOON', 'Nachmittag'), ('EVENING', 'Abend'), ('OTHER', 'Sonstige')], default='MORNING', max_length=20, verbose_name='Schicht')),
                ('notes', models.TextField(blank=True, null=True, verbose_name='Anmerkungen')),
                ('employee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
