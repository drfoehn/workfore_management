...
urlpatterns = [
    ...
    path('api/therapist-booking/<int:pk>/', 
         views.TherapistBookingDetailView.as_view(), 
         name='api-therapist-booking-get'),
    path('api/therapist-booking/<str:date>/add/', 
         views.TherapistBookingCreateView.as_view(), 
         name='api-therapist-booking-add'),
    path('api/therapist-booking/<int:pk>/update/', 
         views.TherapistBookingUpdateView.as_view(), 
         name='api-therapist-booking-update'),
    path('api/therapist-booking/<int:pk>/delete/', 
         views.TherapistBookingDeleteView.as_view(), 
         name='api-therapist-booking-delete'),
